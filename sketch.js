...
function draw() {
 ...
 background('black');
fill('red')
text('PUT THE WASTE IN THE RIGHT PLACE',300,100)
fill('green')
text('DUSTBIN',490,450)
 drawSprites();
...
function keyPressed(){
  if(keyCode===UP_ARROW){
   Matter.Body.applyForce(waste.body,waste.body.position,{x:40,y:-50})
  }
}
